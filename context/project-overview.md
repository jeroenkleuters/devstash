...
**Design language:** modern, minimal, dev-focused. Dark mode by default, light mode optional. Clean typography, generous whitespace, subtle borders/shadows. References: Notion, Linear, Raycast. Syntax highlighting on all code blocks.
