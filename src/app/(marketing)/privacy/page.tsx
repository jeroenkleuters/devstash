...
export const metadata: Metadata = {
  title: "Privacy · DevSquirrel",
  description:
    "What DevSquirrel stores, what the AI features send to OpenAI, and how to turn them off.",
};
    ...
    <article className="legal">
      <header className="legal-header">
        ...
        <p className="legal-lede">
          What DevSquirrel stores, who else touches it, and what the AI features
      ...
      <section className="legal-section">
        ...
        <p>
          ...
          DevSquirrel rather than from a public URL, so a file is reachable only
      ...
      <section className="legal-section">
        ...
        <p>
          AI features are part of DevSquirrel Pro. They are{" "}
      ...
      <section className="legal-section">
        ...
        <p>
          DevSquirrel is built on services that each handle one part of it:
        </p>
      ...
      <section className="legal-section">
        ...
        <p>
          ...
          <strong>Card details never reach DevSquirrel</strong> — you enter them
